...
# Paths
root = '/Users/zvimarmor/Sompolinski\'s Lab/results/2026_03_29/'
xu_json = os.path.join(root, 'smoke_test_xu_20.json')
extrap_json = os.path.join(root, 'smoke_test_extrap_20.json')
out_md = os.path.join(root, 'smoke_test_results.md')

combined_md = json_to_md_content(xu_json, "Xu Dataset (Repetition Mitigation)")
combined_md += "\n\n"
combined_md += json_to_md_content(extrap_json, "Extrapolation Dataset (Repetition Mitigation)")
